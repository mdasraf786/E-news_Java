    ...
    <div class="profile-section">
        <div class="row">
            ...
            <div class="col-auto ml-auto">
                <button class="btn edit-profile btn-toggle text-primary" id="transparent">
        ...
        <div class="edit-form mt-3" style="display: none;">
            <form action="editprofile.php?email=<?php echo $row['email']?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="firstname" value="<%= session.getAttribute("fname") %>">
                </div>
                <div class="form-group">
                    <label for="birthday">MName</label>
                    <input type="text" class="form-control" id="birthday" name="middlename" value="<%= session.getAttribute("mname") %>">
                </div>
                <div class="form-group">
                    <label for="birthday">LName</label>
                    <input type="text" class="form-control" id="birthday" name="lastname" value="<%= session.getAttribute("lname") %>">
                </div>
                <div class="form-group">
                    <label for="birthday">Birthday</label>
                    <input type="date" class="form-control" id="birthday" name="dob" value="<%= session.getAttribute("dob") %>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="country" value="<%= session.getAttribute("gender") %>" name="gender">
                </div>
                <button type="submit" class="btn text-primary" id="transparent" name="submit">Save</button>
                <a href="profile.jsp" class="btn text-primary">Cancel</a>
            </form>
        </div>
    </div>
</div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <a href="changepassword.php" class="btn text-primary">Change Password?</a>
                </div>
            </div>
        </div>
        <div class="col-sm-2"></div>
